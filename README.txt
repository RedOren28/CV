...
- Il ne vous reste plus qu'a ouvrir le fichier index.html dans le navigateur web de votre choix ! (Si un problème survient merci d'essayer avec un navigateur différent)
